...
//micro site일때 자동 Exit Link track 하지 않음 
	  ...
	  /* SEC B2B, CN Store */
s.linkInternalFilters="JAVA-SCRIPT:,tel:,my-samsung.com,samsungshop.com.cn,www.samsungb2b.co.kr,www.samsung.com,japan.samsung.com,2.samsung.com,3.samsung.com,4.samsung.com,shop.samsung.com,store.samsung.com,local.sec.samsung.com,ru.samsung.com,eu.samsung.com"; 
...
/*END : ad an fr country rule by analyticsITC 2017.01.02*/
	...
	if(logCheck == undefined && logCheck == null){
		...
		"au,cn,nz,es,fr,it,nl,de,se,uk,sec,ru,be,be_fr,pl,dk,fi,no,ch,ch_fr,pt,in,uk-epp,uk-epp-networks".indexOf(getOmniSiteCd())!=-1? s.prop10 = "logged in": s.prop10 = "logged out";
...
function sendScPurchaseSucc(order,pId,dOption,pMethod,pOption){
	//var productNo="";
	var tempNo=null;
	var splitOrder="";
    var pOptions = "";
	...
	s.purchaseID=pId;
	s.eVar50=pId;
	s.linkTrackVars="eVar37,events,products,purchaseID,prop38,eVar50";
	s.linkTrackEvents="purchase";
	s.events="purchase";
	setClickVar();
	s.tl(true,"o","scPurchase");
...
function getdil_Local_Account(){
	...
	var useDilCountry =  ['sa','sa_en','uk','ae','ae_ar','fr','de','it','au','se','fi','no','dk','pl','nl','be','be_fr','id','th','tr','levant'/*'ru'*/];
	var useDilYNCountry = "";
		...
		if(getOmniSiteCd() == useDilCountry[idx]){
			...
			switch(useDilCountry[idx]){
				...
				case 'tr'    : useDilYNCountry = 'samsungturkey';		
											 break; 	
				case 'levant' : useDilYNCountry = 'samsunglevant'; 			/* AM DIL code 추가 (levant) */
											 break; 
