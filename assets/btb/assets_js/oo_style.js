...
var
  pathToAssets = '/common/img/onlineopinionV5/',
  ...
  tab_gif = pathToAssets + 'oo_tab_icon_ffffff.gif',
...
if(cleanURL.indexOf('sec') > -1) {
  tab_png = pathToAssets + 'oo_tab_korean_ffffff.png';
  tab_padding = '52px 0';
  tab_span_left = '6px';
} else if(cleanURL.indexOf('br') > -1) {
  tab_png = pathToAssets + 'oo_tab_portuguese_ffffff.png';
  tab_padding = '52px 0 51px 0';
  tab_top = '38%';
} else if(cleanURL.indexOf('cn') > -1) {
  tab_png = pathToAssets + 'oo_tab_chinese_simplified_ffffff.png';
  tab_padding = '53px 0';
} else if(cleanURL.indexOf('fr') > -1) {
  tab_png = pathToAssets + 'oo_tab_french_ffffff.png';
  tab_padding = '73px 0';
  tab_top = '35%';
} else if(cleanURL.indexOf('in') > -1) {
  tab_png = pathToAssets + 'oo_tab_english_ffffff.png';
} else if(cleanURL.indexOf('it') > -1) {
  tab_png = pathToAssets + 'oo_tab_italian_ffffff.png';
  tab_padding = '48px 0';
  tab_top = '38%';
  tab_span_left = '8px';
} else if(cleanURL.indexOf('ru') > -1) {
  tab_png = pathToAssets + 'oo_tab_russian_ffffff.png';
  tab_padding = '76px 0';
  tab_top = '34%';
} else if(cleanURL.indexOf('th') > -1) {
  tab_png = pathToAssets + 'oo_tab_thai_ffffff.png';
  tab_padding = '52px 0';
  tab_top = '37%';
  tab_span_left = '8px';
...
cssText += "\n#oo_tab { background-color: #0071BF; border: 1px solid #cccccc; display: block; position: fixed; top: " + tab_top + "; padding: " + tab_padding +  "; width: 35px; z-index: 999995; cursor: pointer; }";
...
cssText += "\n.oo_tab_right { right: -13px; border-radius: 9px 0px 0px 9px; -moz-border-radius: 9px 0px 0px 9px; -webkit-border-radius: 9px 0px 0px 9px; transition: right .5s; -moz-transition: right .5s; -webkit-transition: right .5s; -o-transition: right .5s; background-image: -webkit-gradient(linear, 0% 100%, 0% 0%, from(#0071BF), to(#0071BF)); background-image: -webkit-linear-gradient(left, #0071BF, #0071BF); background-image: -moz-linear-gradient(left, #0071BF, #0071BF); background-image: -ms-linear-gradient(left, #0071BF, #0071BF); background-image: -o-linear-gradient(left, #0071BF, #0071BF); background-image: linear-gradient(left, #0071BF, #0071BF); }";
cssText += "\n.oo_tab_right span { left: " + tab_span_left + "; }";
cssText += "\n.oo_tab_right div { background-position: -6px -10px; }";
cssText += "\n.oo_tab_right:hover { right: -5px; }";

// Italian Tab Styles //
if(cleanURL.indexOf('it') > -1) {
  cssText += "\n#oo_tab div { background-image: url(" + tab_png + "); background-repeat: no-repeat; position: absolute; display: block; height: 103%; left: 0; top: 0; width: 100%; }";
  cssText += "\n.oo_tab_right { right: -13px; border-radius: 9px 0px 0px 9px; -moz-border-radius: 9px 0px 0px 9px; -webkit-border-radius: 9px 0px 0px 9px; transition: right .5s; -moz-transition: right .5s; -webkit-transition: right .5s; -o-transition: right .5s; background-image: -webkit-gradient(linear, 0% 100%, 0% 0%, from(#0071BF), to(#0071BF)); background-image: -webkit-linear-gradient(left, #0071BF, #0071BF); background-image: -moz-linear-gradient(left, #0071BF, #0071BF); background-image: -ms-linear-gradient(left, #0071BF, #0071BF); background-image: -o-linear-gradient(left, #0071BF, #0071BF); background-image: linear-gradient(left, #0071BF, #0071BF); }";
  cssText += "\n.oo_tab_right span { left: 7px; }";
  cssText += "\n.oo_tab_right div { background-position: -7px -16px; }";
  cssText += "\n.oo_tab_right:hover { right: -5px; }";
}

// Russian Tab Styles //
if(cleanURL.indexOf('ru') > -1) {
  cssText += "\n#oo_tab { background-color: #0071BF; border: 1px solid #cccccc; display: block; position: fixed; top: 40%; padding: 85px 0px 55px 0px; width: 35px; z-index: 999995; cursor: pointer; }";
  cssText += "\n#oo_tab div { background-image: url(" + tab_png + "); background-repeat: no-repeat; position: absolute; display: block; height: 103%; left: 0; top: 0; width: 100%; }";
  cssText += "\n.oo_tab_right { right: -13px; border-radius: 9px 0px 0px 9px; -moz-border-radius: 9px 0px 0px 9px; -webkit-border-radius: 9px 0px 0px 9px; transition: right .5s; -moz-transition: right .5s; -webkit-transition: right .5s; -o-transition: right .5s; background-image: -webkit-gradient(linear, 0% 100%, 0% 0%, from(#0071BF), to(#0071BF)); background-image: -webkit-linear-gradient(left, #0071BF, #0071BF); background-image: -moz-linear-gradient(left, #0071BF, #0071BF); background-image: -ms-linear-gradient(left, #0071BF, #0071BF); background-image: -o-linear-gradient(left, #0071BF, #0071BF); background-image: linear-gradient(left, #0071BF, #0071BF); }";
  cssText += "\n.oo_tab_right span { left: 7px; }";
  cssText += "\n.oo_tab_right div { background-position: -6px -16px; }";
  cssText += "\n.oo_tab_right:hover { right: -5px; }";
}

// French Tab Styles //
if(cleanURL.indexOf('fr') > -1) {
  cssText += "\n#oo_tab { background-color: #0071BF; border: 1px solid #cccccc; display: block; position: fixed; top: 40%; padding: 85px 0px 55px 0px; width: 35px; z-index: 999995; cursor: pointer; }";
  cssText += "\n#oo_tab div { background-image: url(" + tab_png + "); background-repeat: no-repeat; position: absolute; display: block; height: 103%; left: 0; top: 0; width: 100%; }";
  cssText += "\n.oo_tab_right { right: -13px; border-radius: 9px 0px 0px 9px; -moz-border-radius: 9px 0px 0px 9px; -webkit-border-radius: 9px 0px 0px 9px; transition: right .5s; -moz-transition: right .5s; -webkit-transition: right .5s; -o-transition: right .5s; background-image: -webkit-gradient(linear, 0% 100%, 0% 0%, from(#0071BF), to(#0071BF)); background-image: -webkit-linear-gradient(left, #0071BF, #0071BF); background-image: -moz-linear-gradient(left, #0071BF, #0071BF); background-image: -ms-linear-gradient(left, #0071BF, #0071BF); background-image: -o-linear-gradient(left, #0071BF, #0071BF); background-image: linear-gradient(left, #0071BF, #0071BF); }";
  cssText += "\n.oo_tab_right span { left: 7px; }";
...
// Thai Tab Styles //
if(cleanURL.indexOf('th') > -1) {
  cssText += "\n#oo_tab { background-color: #0071BF; border: 1px solid #cccccc; display: block; position: fixed; top: 40%; padding: 66px 0px 55px 0px; width: 35px; z-index: 999995; cursor: pointer; }";
  cssText += "\n#oo_tab div { background-image: url(" + tab_png + "); background-repeat: no-repeat; position: absolute; display: block; height: 103%; left: 0; top: 0; width: 100%; }";
  cssText += "\n.oo_tab_right { right: -13px; border-radius: 9px 0px 0px 9px; -moz-border-radius: 9px 0px 0px 9px; -webkit-border-radius: 9px 0px 0px 9px; transition: right .5s; -moz-transition: right .5s; -webkit-transition: right .5s; -o-transition: right .5s; background-image: -webkit-gradient(linear, 0% 100%, 0% 0%, from(#0071BF), to(#0071BF)); background-image: -webkit-linear-gradient(left, #0071BF, #0071BF); background-image: -moz-linear-gradient(left, #0071BF, #0071BF); background-image: -ms-linear-gradient(left, #0071BF, #0071BF); background-image: -o-linear-gradient(left, #0071BF, #0071BF); background-image: linear-gradient(left, #0071BF, #0071BF); }";
  cssText += "\n.oo_tab_right span { left: 7px; }";
  cssText += "\n.oo_tab_right div { background-position: -7px -16px; }";
